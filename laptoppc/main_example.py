...
from tools import data_path, root_path
from predict import load_model, predict_with_heatmap_for


"""
This runs a handful of example predictions as a sanity check.
This is NOT meant as accuracy or performance verification!
"""
